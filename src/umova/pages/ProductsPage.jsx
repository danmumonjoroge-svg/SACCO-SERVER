...
import { ScannerModal, useBarcodeScanner } from '../../scanning';
import { AuthContext } from '../context/authContext';

export default function ProductsPage({ businessId }) {
  const { user } = useContext(AuthContext);
  const tenantId = user?.tenant_id;
  const { products, loading, create, update, remove } = useProducts(businessId);
