...
// product. POS, GRN, Stocktake, Transfers and Returns all call this
// service instead of querying lb_products directly, so "what counts as a
// usable product" logic lives in exactly one place.
//
// Adapted: tenant_id/business_id stripped throughout — this app is
// single-org (see usePosErpAuth.js), and lb_products has no such columns
// (see productService.js). Scanning identifies a product; it never
// touches inventory.
